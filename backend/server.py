...
Составь краткий персонализированный прогноз на 2026 год (2 небольших абзаца):

Первый абзац: опиши ключевые энергии года через планету Махадаши и её положение. Какие сферы жизни в фокусе, основные возможности периода.

Второй абзац: дай 2-3 практические рекомендации для реализации потенциала. Заверши позитивным акцентом.

Стиль: конкретный, лаконичный, без общих фраз. Текст должен быть компактным и читаемым."""
